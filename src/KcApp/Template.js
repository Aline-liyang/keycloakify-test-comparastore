...
import logo_comparastore from "./logo_comparastore.svg";
import "./KcApp.css";
...
const Template = memo((props) => {
    ...
    const onChangeLanguageClickFactory = useCallbackFactory(([kcLanguageTag]) => changeLocale(kcLanguageTag));

    const onTryAnotherWayClick = useConstCallback(() => (document.forms["kc-select-try-another-way-form" ].submit(), false));
